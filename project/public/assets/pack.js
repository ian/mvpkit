...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {const is      = __webpack_require__(2)

	global.Tether = __webpack_require__(3)
...
/***/ function(module, exports) {
	...
	Controller = (function() {
	  function Controller() {
	    this.thanks = bind(this.thanks, this);
	    this.index = bind(this.index, this);
	  }

	  Controller.prototype.index = function() {
	    $('#new_conversion').on('submit', function(e) {
	      return window.track("Conversion Submit", {
	        source: "Registration Form"
	      });
	    });
	    return $('#new_conversion').on('ajax:success', function() {
	      return top.location = "/conversion";
	    });
	  };

	  Controller.prototype.thanks = function() {};
